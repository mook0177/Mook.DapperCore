...
namespace Mook.DapperCore
{
    ...
    public partial interface IRepository<T> : IRepository where T : class, new()
    {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        IEnumerable<T> GetList(object filterCondition, IDbTransaction transaction = null, int? commandTimeout = null);
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        Task<IEnumerable<T>> GetListAsync(object filterCondition, IDbTransaction transaction = null, int? commandTimeout = null);
