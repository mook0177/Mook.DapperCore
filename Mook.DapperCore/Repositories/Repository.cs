...
namespace Mook.DapperCore
{
    ...
    public partial class Repository<T> : Repository, IRepository<T> where T : class, new()
    {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public virtual IEnumerable<T> GetList(object filterCondition, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            return _dbConn.GetList<T>(filterCondition, transaction, commandTimeout);
        }
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public virtual async Task<IEnumerable<T>> GetListAsync(object filterCondition, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            return await _dbConn.GetListAsync<T>(filterCondition, transaction, commandTimeout);
        }
